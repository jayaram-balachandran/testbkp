  ...
  mongoose
    ...
    app.post("/saveagent", function (req, res) {
      ...
      app.put("/updateagent", function(req,res){
          const updateAgentId = req.body.id;
          console.log("Update Agent id", updateAgentId);
          ...
          const updateAgent = existAgents.filter( agent => agent.id !== updateAgentId );
    ...
    app.post("/deleteagent", function (req, res) {
        ...
        console.log("Agent Id to be deleted", agentId);

            //get the existing user data
            const existAgents = getAgentData();

            //filter the userdata to remove it
            const filterAgent = existAgents.filter( agent => agent.id !== agentId );
